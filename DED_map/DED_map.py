...
print(f' MEAN AMPLITUDE DIFFERENCE/<WEIGHT>           :  {DFDW:14.4f}')
print(f' MEAN AMPLITUDE DIFFERENCE SQUARED            :  {DFM**2:14.4e}')
print(f' MEAN ABSOLUTE AMPLITUDE DIFFERENCE           :  {ADFM:14.4f}')
print(f' MEAN ABSOLUTE AMPLITUDE DIFFERENCE SQUARED   :  {ADFM**2:14.4f}')
print(f' MEAN SQUARE AMPLITUDE DIFFERENCE             :  {DFSQM:14.4f}')
print(f' MEAN SIGMA OF DIFFERENCE AMPLITUDES          :  {S12M:14.4f}')
print(f' MEAN SIGMA OF DIFFERENCE AMPLITUDES SQUARED  :  {S12M**2:14.4f}')
print(f' MEAN SQUARE SIGMA OF DIFFERENCE AMPLITUDES   :  {S12SQM:14.4f}')
