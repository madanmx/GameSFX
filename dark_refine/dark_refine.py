...
refmac = (
    f"refmac5 HKLIN dark.mtz HKLOUT dark_phases.mtz XYZIN dark_start.pdb XYZOUT dark.pdb LIBIN <file.cif> << eof > refmac_log \n"
...
#Check the dark.pdb output from this script in coot then fit the residues/water/ligands if necessary and rerun this script by changing the input pdb name
